...
class GRPO(FinetuneTeleprompter):
    def __init__(
        ...
        variably_invoked_predictor_grouping_mode: Union[
        ...
        if valset is not None:
            ...
            if self.report_train_scores:
                ...
                if step_idx == -1:
                    ...
                    logger.info(
                        f"Student program validation set score after training step {step_idx + 1}/{self.num_train_steps}: {valset_evaluation[0]}"
                    )
        else:
            ...
            if self.report_train_scores:
                ...
                if step_idx == -1:
                    ...
                    logger.info(
                        f"Student program training set score after training step {step_idx + 1}/{self.num_train_steps}: {valset_evaluation[0]}"
                    )
            else:
